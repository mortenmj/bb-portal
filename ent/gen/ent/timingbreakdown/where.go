...
func HasExectionInfo() predicate.TimingBreakdown {
...
// HasExectionInfoWith applies the HasEdge predicate on the "exection_info" edge with a given conditions (other predicates).
func HasExectionInfoWith(preds ...predicate.ExectionInfo) predicate.TimingBreakdown {
	return predicate.TimingBreakdown(func(s *sql.Selector) {
		step := newExectionInfoStep()
