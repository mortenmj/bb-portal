...
func (acsu *ActionCacheStatisticsUpdate) SetSizeInBytes(i int64) *ActionCacheStatisticsUpdate {
	acsu.mutation.ResetSizeInBytes()
	acsu.mutation.SetSizeInBytes(i)
	return acsu
}

// SetNillableSizeInBytes sets the "size_in_bytes" field if the given value is not nil.
func (acsu *ActionCacheStatisticsUpdate) SetNillableSizeInBytes(i *int64) *ActionCacheStatisticsUpdate {
	if i != nil {
		acsu.SetSizeInBytes(*i)
	}
	return acsu
}

// AddSizeInBytes adds i to the "size_in_bytes" field.
func (acsu *ActionCacheStatisticsUpdate) AddSizeInBytes(i int64) *ActionCacheStatisticsUpdate {
	acsu.mutation.AddSizeInBytes(i)
	return acsu
}
...
func (acsu *ActionCacheStatisticsUpdate) SetSaveTimeInMs(i int64) *ActionCacheStatisticsUpdate {
	acsu.mutation.ResetSaveTimeInMs()
	acsu.mutation.SetSaveTimeInMs(i)
	return acsu
}

// SetNillableSaveTimeInMs sets the "save_time_in_ms" field if the given value is not nil.
func (acsu *ActionCacheStatisticsUpdate) SetNillableSaveTimeInMs(i *int64) *ActionCacheStatisticsUpdate {
	if i != nil {
		acsu.SetSaveTimeInMs(*i)
	}
	return acsu
}

// AddSaveTimeInMs adds i to the "save_time_in_ms" field.
func (acsu *ActionCacheStatisticsUpdate) AddSaveTimeInMs(i int64) *ActionCacheStatisticsUpdate {
	acsu.mutation.AddSaveTimeInMs(i)
	return acsu
}
...
func (acsu *ActionCacheStatisticsUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := acsu.mutation.AddedSizeInBytes(); ok {
		_spec.AddField(actioncachestatistics.FieldSizeInBytes, field.TypeInt64, value)
	}
	if acsu.mutation.SizeInBytesCleared() {
		_spec.ClearField(actioncachestatistics.FieldSizeInBytes, field.TypeInt64)
	}
	...
	if value, ok := acsu.mutation.AddedSaveTimeInMs(); ok {
		_spec.AddField(actioncachestatistics.FieldSaveTimeInMs, field.TypeInt64, value)
	}
	if acsu.mutation.SaveTimeInMsCleared() {
		_spec.ClearField(actioncachestatistics.FieldSaveTimeInMs, field.TypeInt64)
	}
...
// SetSizeInBytes sets the "size_in_bytes" field.
func (acsuo *ActionCacheStatisticsUpdateOne) SetSizeInBytes(i int64) *ActionCacheStatisticsUpdateOne {
	acsuo.mutation.ResetSizeInBytes()
	acsuo.mutation.SetSizeInBytes(i)
	return acsuo
}

// SetNillableSizeInBytes sets the "size_in_bytes" field if the given value is not nil.
func (acsuo *ActionCacheStatisticsUpdateOne) SetNillableSizeInBytes(i *int64) *ActionCacheStatisticsUpdateOne {
	if i != nil {
		acsuo.SetSizeInBytes(*i)
	}
	return acsuo
}

// AddSizeInBytes adds i to the "size_in_bytes" field.
func (acsuo *ActionCacheStatisticsUpdateOne) AddSizeInBytes(i int64) *ActionCacheStatisticsUpdateOne {
	acsuo.mutation.AddSizeInBytes(i)
	return acsuo
}
...
// SetSaveTimeInMs sets the "save_time_in_ms" field.
func (acsuo *ActionCacheStatisticsUpdateOne) SetSaveTimeInMs(i int64) *ActionCacheStatisticsUpdateOne {
	acsuo.mutation.ResetSaveTimeInMs()
	acsuo.mutation.SetSaveTimeInMs(i)
	return acsuo
}

// SetNillableSaveTimeInMs sets the "save_time_in_ms" field if the given value is not nil.
func (acsuo *ActionCacheStatisticsUpdateOne) SetNillableSaveTimeInMs(i *int64) *ActionCacheStatisticsUpdateOne {
	if i != nil {
		acsuo.SetSaveTimeInMs(*i)
	}
	return acsuo
}

// AddSaveTimeInMs adds i to the "save_time_in_ms" field.
func (acsuo *ActionCacheStatisticsUpdateOne) AddSaveTimeInMs(i int64) *ActionCacheStatisticsUpdateOne {
	acsuo.mutation.AddSaveTimeInMs(i)
	return acsuo
}
