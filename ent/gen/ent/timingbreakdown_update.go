...
func (tbu *TimingBreakdownUpdate) AddExectionInfoIDs(ids ...int) *TimingBreakdownUpdate {
	tbu.mutation.AddExectionInfoIDs(ids...)
	return tbu
}

// AddExectionInfo adds the "exection_info" edges to the ExectionInfo entity.
func (tbu *TimingBreakdownUpdate) AddExectionInfo(e ...*ExectionInfo) *TimingBreakdownUpdate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return tbu.AddExectionInfoIDs(ids...)
}
...
// ClearExectionInfo clears all "exection_info" edges to the ExectionInfo entity.
func (tbu *TimingBreakdownUpdate) ClearExectionInfo() *TimingBreakdownUpdate {
	tbu.mutation.ClearExectionInfo()
	return tbu
}

// RemoveExectionInfoIDs removes the "exection_info" edge to ExectionInfo entities by IDs.
func (tbu *TimingBreakdownUpdate) RemoveExectionInfoIDs(ids ...int) *TimingBreakdownUpdate {
	tbu.mutation.RemoveExectionInfoIDs(ids...)
	return tbu
}

// RemoveExectionInfo removes "exection_info" edges to ExectionInfo entities.
func (tbu *TimingBreakdownUpdate) RemoveExectionInfo(e ...*ExectionInfo) *TimingBreakdownUpdate {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return tbu.RemoveExectionInfoIDs(ids...)
}
...
func (tbu *TimingBreakdownUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := tbu.mutation.RemovedExectionInfoIDs(); len(nodes) > 0 && !tbu.mutation.ExectionInfoCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   timingbreakdown.ExectionInfoTable,
	...
	if nodes := tbu.mutation.ExectionInfoIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   timingbreakdown.ExectionInfoTable,
...
// AddExectionInfoIDs adds the "exection_info" edge to the ExectionInfo entity by IDs.
func (tbuo *TimingBreakdownUpdateOne) AddExectionInfoIDs(ids ...int) *TimingBreakdownUpdateOne {
	tbuo.mutation.AddExectionInfoIDs(ids...)
	return tbuo
}

// AddExectionInfo adds the "exection_info" edges to the ExectionInfo entity.
func (tbuo *TimingBreakdownUpdateOne) AddExectionInfo(e ...*ExectionInfo) *TimingBreakdownUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return tbuo.AddExectionInfoIDs(ids...)
}
...
// ClearExectionInfo clears all "exection_info" edges to the ExectionInfo entity.
func (tbuo *TimingBreakdownUpdateOne) ClearExectionInfo() *TimingBreakdownUpdateOne {
	tbuo.mutation.ClearExectionInfo()
	return tbuo
}

// RemoveExectionInfoIDs removes the "exection_info" edge to ExectionInfo entities by IDs.
func (tbuo *TimingBreakdownUpdateOne) RemoveExectionInfoIDs(ids ...int) *TimingBreakdownUpdateOne {
	tbuo.mutation.RemoveExectionInfoIDs(ids...)
	return tbuo
}

// RemoveExectionInfo removes "exection_info" edges to ExectionInfo entities.
func (tbuo *TimingBreakdownUpdateOne) RemoveExectionInfo(e ...*ExectionInfo) *TimingBreakdownUpdateOne {
	ids := make([]int, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return tbuo.RemoveExectionInfoIDs(ids...)
}
...
func (tbuo *TimingBreakdownUpdateOne) sqlSave(ctx context.Context) (_node *TimingBreakdown, err error) {
	...
	if nodes := tbuo.mutation.RemovedExectionInfoIDs(); len(nodes) > 0 && !tbuo.mutation.ExectionInfoCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   timingbreakdown.ExectionInfoTable,
	...
	if nodes := tbuo.mutation.ExectionInfoIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   timingbreakdown.ExectionInfoTable,
