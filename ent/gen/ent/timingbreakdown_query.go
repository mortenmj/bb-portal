...
type TimingBreakdownQuery struct {
	...
	withExectionInfo      *ExectionInfoQuery
	withChild             *TimingChildQuery
	modifiers             []func(*sql.Selector)
	loadTotal             []func(context.Context, []*TimingBreakdown) error
	withNamedExectionInfo map[string]*ExectionInfoQuery
...
// QueryExectionInfo chains the current query on the "exection_info" edge.
func (tbq *TimingBreakdownQuery) QueryExectionInfo() *ExectionInfoQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, timingbreakdown.ExectionInfoTable, timingbreakdown.ExectionInfoColumn),
		)
...
func (tbq *TimingBreakdownQuery) Clone() *TimingBreakdownQuery {
	...
	return &TimingBreakdownQuery{
		...
		withExectionInfo: tbq.withExectionInfo.Clone(),
...
// WithExectionInfo tells the query-builder to eager-load the nodes that are connected to
// the "exection_info" edge. The optional arguments are used to configure the query builder of the edge.
func (tbq *TimingBreakdownQuery) WithExectionInfo(opts ...func(*ExectionInfoQuery)) *TimingBreakdownQuery {
	query := (&ExectionInfoClient{config: tbq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tbq.withExectionInfo = query
	return tbq
}
...
func (tbq *TimingBreakdownQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TimingBreakdown, error) {
	...
	if query := tbq.withExectionInfo; query != nil {
		if err := tbq.loadExectionInfo(ctx, query, nodes,
			func(n *TimingBreakdown) { n.Edges.ExectionInfo = []*ExectionInfo{} },
			func(n *TimingBreakdown, e *ExectionInfo) { n.Edges.ExectionInfo = append(n.Edges.ExectionInfo, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range tbq.withNamedExectionInfo {
		if err := tbq.loadExectionInfo(ctx, query, nodes,
			func(n *TimingBreakdown) { n.appendNamedExectionInfo(name) },
			func(n *TimingBreakdown, e *ExectionInfo) { n.appendNamedExectionInfo(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (tbq *TimingBreakdownQuery) loadExectionInfo(ctx context.Context, query *ExectionInfoQuery, nodes []*TimingBreakdown, init func(*TimingBreakdown), assign func(*TimingBreakdown, *ExectionInfo)) error {
	...
	query.Where(predicate.ExectionInfo(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(timingbreakdown.ExectionInfoColumn), fks...))
	}))
...
// WithNamedExectionInfo tells the query-builder to eager-load the nodes that are connected to the "exection_info"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (tbq *TimingBreakdownQuery) WithNamedExectionInfo(name string, opts ...func(*ExectionInfoQuery)) *TimingBreakdownQuery {
	query := (&ExectionInfoClient{config: tbq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if tbq.withNamedExectionInfo == nil {
		tbq.withNamedExectionInfo = make(map[string]*ExectionInfoQuery)
	}
	tbq.withNamedExectionInfo[name] = query
	return tbq
}
