...
func (plmu *PackageLoadMetricsUpdate) SetNumTargets(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.ResetNumTargets()
	plmu.mutation.SetNumTargets(i)
	return plmu
}

// SetNillableNumTargets sets the "num_targets" field if the given value is not nil.
func (plmu *PackageLoadMetricsUpdate) SetNillableNumTargets(i *int64) *PackageLoadMetricsUpdate {
	if i != nil {
		plmu.SetNumTargets(*i)
	}
	return plmu
}

// AddNumTargets adds i to the "num_targets" field.
func (plmu *PackageLoadMetricsUpdate) AddNumTargets(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.AddNumTargets(i)
	return plmu
}
...
func (plmu *PackageLoadMetricsUpdate) SetComputationSteps(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.ResetComputationSteps()
	plmu.mutation.SetComputationSteps(i)
	return plmu
}

// SetNillableComputationSteps sets the "computation_steps" field if the given value is not nil.
func (plmu *PackageLoadMetricsUpdate) SetNillableComputationSteps(i *int64) *PackageLoadMetricsUpdate {
	if i != nil {
		plmu.SetComputationSteps(*i)
	}
	return plmu
}

// AddComputationSteps adds i to the "computation_steps" field.
func (plmu *PackageLoadMetricsUpdate) AddComputationSteps(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.AddComputationSteps(i)
	return plmu
}
...
func (plmu *PackageLoadMetricsUpdate) SetNumTransitiveLoads(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.ResetNumTransitiveLoads()
	plmu.mutation.SetNumTransitiveLoads(i)
	return plmu
}

// SetNillableNumTransitiveLoads sets the "num_transitive_loads" field if the given value is not nil.
func (plmu *PackageLoadMetricsUpdate) SetNillableNumTransitiveLoads(i *int64) *PackageLoadMetricsUpdate {
	if i != nil {
		plmu.SetNumTransitiveLoads(*i)
	}
	return plmu
}

// AddNumTransitiveLoads adds i to the "num_transitive_loads" field.
func (plmu *PackageLoadMetricsUpdate) AddNumTransitiveLoads(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.AddNumTransitiveLoads(i)
	return plmu
}
...
func (plmu *PackageLoadMetricsUpdate) SetPackageOverhead(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.ResetPackageOverhead()
	plmu.mutation.SetPackageOverhead(i)
	return plmu
}

// SetNillablePackageOverhead sets the "package_overhead" field if the given value is not nil.
func (plmu *PackageLoadMetricsUpdate) SetNillablePackageOverhead(i *int64) *PackageLoadMetricsUpdate {
	if i != nil {
		plmu.SetPackageOverhead(*i)
	}
	return plmu
}

// AddPackageOverhead adds i to the "package_overhead" field.
func (plmu *PackageLoadMetricsUpdate) AddPackageOverhead(i int64) *PackageLoadMetricsUpdate {
	plmu.mutation.AddPackageOverhead(i)
	return plmu
}
...
func (plmu *PackageLoadMetricsUpdate) AddPackageMetricIDs(ids ...int) *PackageLoadMetricsUpdate {
	plmu.mutation.AddPackageMetricIDs(ids...)
	return plmu
}

// AddPackageMetrics adds the "package_metrics" edges to the PackageMetrics entity.
func (plmu *PackageLoadMetricsUpdate) AddPackageMetrics(p ...*PackageMetrics) *PackageLoadMetricsUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return plmu.AddPackageMetricIDs(ids...)
}
...
func (plmu *PackageLoadMetricsUpdate) RemovePackageMetricIDs(ids ...int) *PackageLoadMetricsUpdate {
	plmu.mutation.RemovePackageMetricIDs(ids...)
	return plmu
}

// RemovePackageMetrics removes "package_metrics" edges to PackageMetrics entities.
func (plmu *PackageLoadMetricsUpdate) RemovePackageMetrics(p ...*PackageMetrics) *PackageLoadMetricsUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return plmu.RemovePackageMetricIDs(ids...)
}
...
func (plmu *PackageLoadMetricsUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := plmu.mutation.AddedNumTargets(); ok {
		_spec.AddField(packageloadmetrics.FieldNumTargets, field.TypeInt64, value)
	}
	if plmu.mutation.NumTargetsCleared() {
		_spec.ClearField(packageloadmetrics.FieldNumTargets, field.TypeInt64)
	}
	...
	if value, ok := plmu.mutation.AddedComputationSteps(); ok {
		_spec.AddField(packageloadmetrics.FieldComputationSteps, field.TypeInt64, value)
	}
	if plmu.mutation.ComputationStepsCleared() {
		_spec.ClearField(packageloadmetrics.FieldComputationSteps, field.TypeInt64)
	}
	...
	if value, ok := plmu.mutation.AddedNumTransitiveLoads(); ok {
		_spec.AddField(packageloadmetrics.FieldNumTransitiveLoads, field.TypeInt64, value)
	}
	if plmu.mutation.NumTransitiveLoadsCleared() {
		_spec.ClearField(packageloadmetrics.FieldNumTransitiveLoads, field.TypeInt64)
	}
	...
	if value, ok := plmu.mutation.AddedPackageOverhead(); ok {
		_spec.AddField(packageloadmetrics.FieldPackageOverhead, field.TypeInt64, value)
	}
	if plmu.mutation.PackageOverheadCleared() {
		_spec.ClearField(packageloadmetrics.FieldPackageOverhead, field.TypeInt64)
	}
	...
	if nodes := plmu.mutation.RemovedPackageMetricsIDs(); len(nodes) > 0 && !plmu.mutation.PackageMetricsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   packageloadmetrics.PackageMetricsTable,
...
// SetNumTargets sets the "num_targets" field.
func (plmuo *PackageLoadMetricsUpdateOne) SetNumTargets(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.ResetNumTargets()
	plmuo.mutation.SetNumTargets(i)
	return plmuo
}

// SetNillableNumTargets sets the "num_targets" field if the given value is not nil.
func (plmuo *PackageLoadMetricsUpdateOne) SetNillableNumTargets(i *int64) *PackageLoadMetricsUpdateOne {
	if i != nil {
		plmuo.SetNumTargets(*i)
	}
	return plmuo
}

// AddNumTargets adds i to the "num_targets" field.
func (plmuo *PackageLoadMetricsUpdateOne) AddNumTargets(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.AddNumTargets(i)
	return plmuo
}
...
// SetComputationSteps sets the "computation_steps" field.
func (plmuo *PackageLoadMetricsUpdateOne) SetComputationSteps(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.ResetComputationSteps()
	plmuo.mutation.SetComputationSteps(i)
	return plmuo
}

// SetNillableComputationSteps sets the "computation_steps" field if the given value is not nil.
func (plmuo *PackageLoadMetricsUpdateOne) SetNillableComputationSteps(i *int64) *PackageLoadMetricsUpdateOne {
	if i != nil {
		plmuo.SetComputationSteps(*i)
	}
	return plmuo
}

// AddComputationSteps adds i to the "computation_steps" field.
func (plmuo *PackageLoadMetricsUpdateOne) AddComputationSteps(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.AddComputationSteps(i)
	return plmuo
}
...
// SetNumTransitiveLoads sets the "num_transitive_loads" field.
func (plmuo *PackageLoadMetricsUpdateOne) SetNumTransitiveLoads(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.ResetNumTransitiveLoads()
	plmuo.mutation.SetNumTransitiveLoads(i)
	return plmuo
}

// SetNillableNumTransitiveLoads sets the "num_transitive_loads" field if the given value is not nil.
func (plmuo *PackageLoadMetricsUpdateOne) SetNillableNumTransitiveLoads(i *int64) *PackageLoadMetricsUpdateOne {
	if i != nil {
		plmuo.SetNumTransitiveLoads(*i)
	}
	return plmuo
}

// AddNumTransitiveLoads adds i to the "num_transitive_loads" field.
func (plmuo *PackageLoadMetricsUpdateOne) AddNumTransitiveLoads(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.AddNumTransitiveLoads(i)
	return plmuo
}
...
// SetPackageOverhead sets the "package_overhead" field.
func (plmuo *PackageLoadMetricsUpdateOne) SetPackageOverhead(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.ResetPackageOverhead()
	plmuo.mutation.SetPackageOverhead(i)
	return plmuo
}

// SetNillablePackageOverhead sets the "package_overhead" field if the given value is not nil.
func (plmuo *PackageLoadMetricsUpdateOne) SetNillablePackageOverhead(i *int64) *PackageLoadMetricsUpdateOne {
	if i != nil {
		plmuo.SetPackageOverhead(*i)
	}
	return plmuo
}

// AddPackageOverhead adds i to the "package_overhead" field.
func (plmuo *PackageLoadMetricsUpdateOne) AddPackageOverhead(i int64) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.AddPackageOverhead(i)
	return plmuo
}
...
// AddPackageMetricIDs adds the "package_metrics" edge to the PackageMetrics entity by IDs.
func (plmuo *PackageLoadMetricsUpdateOne) AddPackageMetricIDs(ids ...int) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.AddPackageMetricIDs(ids...)
	return plmuo
}

// AddPackageMetrics adds the "package_metrics" edges to the PackageMetrics entity.
func (plmuo *PackageLoadMetricsUpdateOne) AddPackageMetrics(p ...*PackageMetrics) *PackageLoadMetricsUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return plmuo.AddPackageMetricIDs(ids...)
}
...
// RemovePackageMetricIDs removes the "package_metrics" edge to PackageMetrics entities by IDs.
func (plmuo *PackageLoadMetricsUpdateOne) RemovePackageMetricIDs(ids ...int) *PackageLoadMetricsUpdateOne {
	plmuo.mutation.RemovePackageMetricIDs(ids...)
	return plmuo
}

// RemovePackageMetrics removes "package_metrics" edges to PackageMetrics entities.
func (plmuo *PackageLoadMetricsUpdateOne) RemovePackageMetrics(p ...*PackageMetrics) *PackageLoadMetricsUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return plmuo.RemovePackageMetricIDs(ids...)
}
...
func (plmuo *PackageLoadMetricsUpdateOne) sqlSave(ctx context.Context) (_node *PackageLoadMetrics, err error) {
	...
	if nodes := plmuo.mutation.RemovedPackageMetricsIDs(); len(nodes) > 0 && !plmuo.mutation.PackageMetricsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   packageloadmetrics.PackageMetricsTable,
