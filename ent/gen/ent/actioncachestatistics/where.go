...
func SizeInBytes(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMs(v int64) predicate.ActionCacheStatistics {
...
func SizeInBytesEQ(v int64) predicate.ActionCacheStatistics {
	return predicate.ActionCacheStatistics(sql.FieldEQ(FieldSizeInBytes, v))
}

// SizeInBytesNEQ applies the NEQ predicate on the "size_in_bytes" field.
func SizeInBytesNEQ(v int64) predicate.ActionCacheStatistics {
...
func SizeInBytesIn(vs ...int64) predicate.ActionCacheStatistics {
...
func SizeInBytesNotIn(vs ...int64) predicate.ActionCacheStatistics {
...
func SizeInBytesGT(v int64) predicate.ActionCacheStatistics {
...
func SizeInBytesGTE(v int64) predicate.ActionCacheStatistics {
...
func SizeInBytesLT(v int64) predicate.ActionCacheStatistics {
...
func SizeInBytesLTE(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsEQ(v int64) predicate.ActionCacheStatistics {
	return predicate.ActionCacheStatistics(sql.FieldEQ(FieldSaveTimeInMs, v))
}

// SaveTimeInMsNEQ applies the NEQ predicate on the "save_time_in_ms" field.
func SaveTimeInMsNEQ(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsIn(vs ...int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsNotIn(vs ...int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsGT(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsGTE(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsLT(v int64) predicate.ActionCacheStatistics {
...
func SaveTimeInMsLTE(v int64) predicate.ActionCacheStatistics {
