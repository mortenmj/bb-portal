...
type PackageLoadMetrics struct {
	...
	ComputationSteps int64 `json:"computation_steps,omitempty"`
	// NumTransitiveLoads holds the value of the "num_transitive_loads" field.
	NumTransitiveLoads int64 `json:"num_transitive_loads,omitempty"`
	// PackageOverhead holds the value of the "package_overhead" field.
	PackageOverhead int64 `json:"package_overhead,omitempty"`
